...
| **6 · Oct 22–28** | Scoreboard #5 + **ROUX November pre-read** (turkey peak spend, low-ticket policy, daily buyability checks Nov 1–23, BFCM runway) · tell Coalition: no BFCM mention before Nov 16, turkey copy stops Nov 23 (Evan) · BFCM ad concepts (Maya) · BFCM page draft by Fri 23 (Nova) · content: Halloween Sat 31, "order in time" turkey, no BFCM (Sage) | **Thu Oct 22** pre-read |

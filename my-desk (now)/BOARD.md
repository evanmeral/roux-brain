...
- ⛔ **Pots are 4mm aluminum, never "cast"** (Evan, 2026-09-11). Still in the live `hpc-dark-evergreen` ad. **Evan is keeping the live ads as they are to avoid a learning reset** (2026-09-11). The v2 image and "4mm aluminum" copy go in at the next refresh, and the old copy is never reused. The 7 unmatched catalog ads are being traced by Finn → [audit](../my-work%20%28outputs%29/content/ads/2026-09-11-live-ad-claims-audit.md).

...
**2. Garrett shoot Tue Sept 22.** Monday shopping pull, then the shoot. Turkey demo must be live by Oct 1.

**3. Tailgate kit ads + retargeting build.** All three concepts approved at all sizes (Evan, 2026-09-18) → [library](../my-skills/hpc-ad-creative/work/creative/library/LIBRARY-LOG.md). **A + B** go into `18qt-TOF` when the kit goes live Sept 25; **C** goes into the 18 QT retargeting set Sept 28. ROUX to confirm the split fits $50/day + $10/day. Retargeting needs `RT - Viewed 18 QT - 30D` built first. Every new ad: full UTMs, Shop off, Messenger off. Pot static still to render (Maya).

*(Demoted from Now: IW checkpoint, done; tailgate concept pick, done; BFCM + Jay text, done.)*
...
| **ROUX** | Confirm tailgate A + B in `18qt-TOF` $50/day and C in 18 QT retargeting $10/day | 2026-09-18 |
...
- **Nova's queue:** Atlas OS follow-ups (Safari "Add to Dock", second-monitor layout, remove the n8n agent + Venon) · **the 6:30 pulse did not run 2026-09-18** (`today.md` still dated 09-17), find out why · ad naming/build process · missing-end-date checklist line · duplicate Performance pots listing · `Commercial Cookers On Sale` has 0 products but is linked from the homepage FAQ · Sage's comment/DM replies file · skill candidates: **discount-code audit** and **Shopify kit build** · product-image library refresh · stray `_m_*`, `__ink_*` and `__tmp_flat_*` helper files in the creative templates folders; the round-1 "Fry standing up" template still carries the patent number. · **Product image library (2026-09-16):** 146 cutouts + 146 studio shots. Open, Evan's eye: five `100-120qt - pwd` and four `Commercial cooker` shots with no gallon size.
...
- ⛔ **Never "patent-pending."** The patent is granted, No. 11,844,459. Live on `Video_Jay 30qt (turkey) Fryer Demo`, which stays on by Evan's call: an accepted risk, not a licence to write it again. · ⛔ **Never the patent number on an ad** (rule 10) · **never a copy-paste of the last creative's layout** (rule 11) · **type minimums are floors, and the product fills its space** (rules 7 and 12).
...
- **Plan** — [PLAN.md](PLAN.md) · [pace line + audiences](../my-work%20(outputs)/internal/reports/2026-09-17-consumer-pace-line-and-audience-sizes.md) · [baseline](../my-work%20(outputs)/internal/reports/2026-09-17-month-plan-baseline.md) · **Atlas OS** — `localhost:4242` · pulse → [today.md](today.md) · notes → [capture.md](capture.md) · [key-dates.md](key-dates.md)

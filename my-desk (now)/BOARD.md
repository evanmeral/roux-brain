...
- **Shopify cleanup (Evan's or Jay's click):** Triple Jet compare-at = price · Scratch & Dent Performance variants carry the Powered cost · duplicate SKU `PW30-VLV075-TFR-B-SBI` · two 18 QT variants with compare-at below price · 25 active products not on the Online Store · an unlisted 40 QT turkey fryer · Platinum's `60 QT / 1" Gate Valve` variant lists **no pot** among its parts.

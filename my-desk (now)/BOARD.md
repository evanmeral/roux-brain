...
| **Evan** | Final read + send the Garrett shoot doc/sheet · pick the seafood for the Fried Foods video (shrimp/fish/soft-shell crab) | 2026-09-14 |
| **Garrett** | High-res tunnel-tube-in-action still — now folded into the Sept 22 shoot (Video 2), not a separate ask | 2026-09-08 |

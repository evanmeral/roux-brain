# Off the board — 2026-09-10

Items removed from BOARD.md at the 2026-09-10 wrap (IntentWave session), kept here so they stay findable.
...
> ✅ Labor Day is fully wound down — 7 ads off, banner off, codes expired on their own.

Already archived in full → [2026-09-09-labor-day-close-out.md](2026-09-09-labor-day-close-out.md).

## Parked lines rewritten

- "**CAC ceilings are provisional** — gross profit per unit is a break-even line, not a spending ceiling. → cac-model-v2" → replaced by v3.
- "**Oversold SKUs / negative inventory.** Digit becomes source of truth for inventory *and* overhead. When it connects, ask about overhead before stock." → overhead now comes from Jay; Evan, 2026-09-10: stock is fine, Digit in a few weeks.
- "Shopify net sales, 13 mo · Aug margin: $2,884,025 · 44.5%" (Numbers) → the 44.5% is stale (pre cost review); the margin of record is 46% from the P&L (Jay, 2026-09-10).

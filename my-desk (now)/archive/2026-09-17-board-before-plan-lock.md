...
| **Evan** | Kit photos — **shooting today, 2026-09-16**; then upload in admin or hand to ROUX. Before activating: check the eligible-discounts collection excludes `Bundle` in admin (connector can't see it) · checkout test | 2026-09-16 |
| **Jay → Evan → Garrett** | Jay completes the dream-client-profile questionnaire (expected Sept 15, not yet received) | 2026-09-14 |
| **Finn** | **Sept 18: run `/hpc-campaign-checkpoint` on the IW lookalike** (Day 7 / ~$700), or sooner if Learning exits — Meta pull + Shopify tagged orders + the zero check, Beau's call, then **Evan decides continue/hold/cut and the creative swap together** | 2026-09-14 |
...
| ⭐ **Marketing room at 20% net** | **$290,600/yr** 🔒 vs **$676k trailing actual** · forward run-rate **~$380k–$417k/yr** → **~$89k–$126k/yr over** | Jay, 2026-09-14 · Beau model, 2026-09-14 |
...
- **Plan (Sept 17–Oct 31)** — [PLAN.md](../PLAN.md): the targets this work heads toward; scored Thursdays, next plan drafted Oct 30 · **ROUX OS** — `localhost:4242`, live as a login item; both calendars connected; pulse is button-only · [spec + build log](../../my-workflows%20(automations)/specs/2026-09-14-roux-os-plan.md) · [README](../../my-workflows%20(automations)/live/roux-os/README.md) · the 6:30 pulse writes [today.md](../today.md) · your notes land in [capture.md](../capture.md) · dates in [key-dates.md](../key-dates.md)

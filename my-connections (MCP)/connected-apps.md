...
| **Canva** | Found **HPC Brand Kit** (`kAHRW3t1WWA`). **Re-verified 2026-09-24:** `list-brand-kits` and `search-designs` both answered (latest designs incl. "Happy Labor day from the HPC family"). The *marketing plugin's* separate Canva server shows "needs authorization"; it is a duplicate, ignore it — this connector is the one to use. | Search, read, create, edit, export designs; brand templates |

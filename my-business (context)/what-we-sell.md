...
**Other discounts in Shopify (Evan, 2026-09-11):** the ~66 unused dollar codes are **customer rewards from the influence.io app**, so never turn them off. The **AMP app's** automatic bundle and upsell discounts stay as they are. **`USATHANKS`** (5%, veterans) was never published because there was no way to verify service. A newer verified military code replaced it, and it will likely be deleted. **`RM40JAY` / `CWBSM40`** are Jay's codes for people who help the shop. Full list → [discount-code sheet](https://docs.google.com/spreadsheets/d/128NBhDPHA1c6O5h96ftGwQERE6guYSzfcjLPl0pf7Sk/edit).

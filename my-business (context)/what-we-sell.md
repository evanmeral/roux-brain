...
🚧 **Three kits exist in Shopify as DRAFTS — not for sale, and not to be quoted to a customer until they go active** *(rebuilt in the Shopify Bundles app 2026-09-17, read back from Shopify the same day; the Sept 16 connector-built drafts are archived)*. **Pricing rule: about 6% off the parts total on every variant** *(Jay via Evan, 2026-09-17)*, replacing the original flat $19.98–$25.98 savings. Compare-at on each variant is the parts total.

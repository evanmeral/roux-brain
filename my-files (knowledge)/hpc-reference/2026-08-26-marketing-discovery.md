...
## ✅ SESSION COMPLETE — 2026-08-26. 14 questions. Interview closed.

## THE TEN THINGS THAT MATTER

1. **Target: $3.0M → $3.5M+, but Jay takes $2M at 20% over $3M at 8%.** Profit is the constraint, revenue is the goal.
2. **The +$500K has to come from June–October.** Evan rejects the slow season outright. De-seasonalizing the brand *is* the strategy.
3. **The year-round products already exist** — fryers, 4-Way Pasta Cooker, Sauce Cooker, banjo burners, steamer trays, consumables, merch, Scratch & Dent. **Positioning problem, not a product problem.**
4. **Tunnel Tube technology is in the POT, not the burner.** A Performance pot is ~$180 cheaper than the Powered rig and runs on any burner the customer owns. Cheapest entry into the technology; creates a real upgrade ladder.
5. **The #1 objection is price — and the answer is the Yeti frame,** in Evan's own words. Reframes price as *frequency* of purchase. The propane savings calculator (already built, currently buried) is the quantified half of that argument.
6. **"A small team of 12 that do everything"** is the trust asset, and it's badly under-used.
...
- 🚫 **Read-only on Shopify / Meta / Google / Klaviyo.** Never change budgets, prices, or settings without asking.
- ✅ **Name the source of every number.** Verify the source is trusted before building on it.
- ✅ **Reconcile every vendor claim against Shopify.**
- 📅 **2026-07-20 is the analytical dividing line** — BM Digital before, Evan (Meta) + Coalition (Google) after.

## ⛔ RULED OUT — do not re-propose
Steamer *units* · Navimow · Predator grills (third-party operated) · Rugged Road coolers ·
dealer/wholesale growth (Jay's lane, no consignment) · free-shipping-in-price test (Jay declined) ·
bundles + gift card (already live since 2026-07-13) · "August is a build month" (concedes the quarter)
...
- ⚠️ **DO NOT USE VENON FOR ANYTHING** (hardened in Q4). Stale and unreliable across the board, not just ads. All Q2 figures RETRACTED. A new data pipeline must be built.
- ✅ **Evan authorized read-only browser access** to Meta Ads Manager and Google Ads via his logged-in Chrome (2026-08-26). ⚠️ **Blocked — Claude in Chrome extension is not connected.** Needs install + sign-in.
- ✅ **Full 122-product catalog pulled** from the public Shopify JSON, unaided. `my-business (context)/what-we-sell.md` rewritten. The brand brief covered ~20 SKUs; the real business is far larger.
- **STANDING RULE: read-only.** Never change data in Shopify / Venon / Meta / Google without asking Evan first.
- **Team:** Evan (lead marketer), **Biljana** (Klaviyo/email marketing associate), Jay (owner).
- What survives from the Q2 pull: Venon has **no COGS, no COGS fallback, no shipping profiles** configured — a config fact, not an attribution number, so its profit display excludes COGS and freight.

- **Revenue:** ~$3.0M last year. Target: **$3.5M minimum** next year (~+17%).
...
### Q1 — Growth posture, revenue target, and the seasonality assumption
- **Asked:** What does winning look like in 12 months — current revenue, target, and would Jay rather have $3M at 8% net or $2M at 20%?
- **Captured:**
...
- **Flags:**
  ...
  - Current net margin % (to know how far from 20% we are) -> **Evan / Jay**
...
**Coverage: May 2026 – Aug 25 2026 only.** Apr 2026 and Nov 2025 return empty — the connector's history starts ~May 2026. No full-year or prior-season data available through this tool.

**All channels, tracked window (~May 1 – Aug 25 2026):**
| Channel | Ad spend | Attr. revenue | ROAS |
|---|---|---|---|
| non_attributed | $0 | $144,271 | — |
| organic | $0 | $102,309 | — |
| meta-ads | $62,891 | $92,058 | 1.46 |
| adwords | $0 | $85,136 | — |
| google | $0 | $68,785 | — |
| direct | $0 | $60,668 | — |
| klaviyo | $0 | $37,254 | — |
| google-ads | $65,406 | $34,052 | 0.52 |
| back-in-stock | $0 | $2,731 | — |
| abandoned_cart | $0 | $1,373 | — |
| shop_app / chatgpt.com / influenceio / shop-website | $0 | ~$3,100 | — |
| **TOTAL** | **$128,297** | **$631,739** | 4.92 blended |

1,358 orders → **AOV ≈ $465.**

**Month by month:**
| Month | Meta spend | Meta rev | Meta ROAS | Google spend | Google rev | Google ROAS | Blended ROAS |
|---|---|---|---|---|---|---|---|
| May 2026 | $15,864 | $14,944 | 0.94 | $11,395 | **$0** | — | **0.55** |
| Jun 2026 | $29,133 | $48,994 | 1.68 | $22,079 | **$0** | — | **0.96** |
| Jul 2026 | $12,808 | $15,422 | 1.20 | $18,157 | **$0** | — | **0.50** |
| Aug 1–25 | $5,086 | $12,697 | **2.50** | $13,774 | $34,052 | **2.47** | **2.48** |
...
- **Attribution is fragmented across three Google buckets** (`google-ads` w/ spend, `adwords` w/ revenue, `google` w/ revenue). The 0.52 lifetime Google ROAS is understated. Combining `google-ads` + `adwords` gives ~1.82. UTM/channel mapping needs cleanup before any Google decision is made.
- **`non_attributed` is the single largest revenue bucket ($144,271, 23%).** Nearly a quarter of revenue has no known source. Likely phone/commercial orders + tracking gaps. Fixing this is worth more than any creative test.
- **Spend is falling:** $27K (May) → $51K (Jun) → $31K (Jul) → $19K (Aug, 25 days). June was the heavy month at 0.96 blended ROAS.
- `chatgpt.com` shows 4 attributed orders — AI-assistant referral traffic is live and measurable. Small, but worth watching.
- Tracked revenue run-rate (~$158K/mo across a slow season) is broadly consistent with a $3M year. Data looks credible.
...
- **RETRACTED from Q2** (all Venon-sourced paid-media figures):
  - ❌ "Google Ads tracking broke May–Jul, $52K blind spend" — this is Venon mis-attributing, not a Google tag failure. No evidence of a real tracking break.
  - ❌ All ROAS by channel and by month, all attributed revenue by channel, the 2.48 August blended ROAS
  - ❌ The `non_attributed` 23% figure and the three-way Google bucket split — artifacts of Venon's attribution
...
- **Flags:**
  ...
  - Should Evan be told Venon's profit numbers exclude COGS/freight? Does anyone read them? -> **Evan**
  - Full marketing team roster beyond Evan + Biljana -> **Evan**

### Q4 — Team, ownership, and access
- **Asked:** Who touches HPC marketing besides Evan, what does each own, who has admin access?
- **Captured:**
  - **Venon rule hardened.** Evan: *"dont use venon for anything, it honestly does not give you the best up to date information and will confuse you on the numbers. So if you need the information lets figure out a new way for you to get that data."* → Not just ads. Everything. A new data pipeline is a project.
  - **Browser access granted:** *"yes pull the meta and google data from my browser but do not change anything on it, you are always read only unless otherwise directed."*
  - **Biljana** — *contracted*. Klaviyo/email. **Runs everything by Evan before implementing.** So Evan is an approval gate on email too.
  - **Meta Ads — Evan runs them himself.** Free advisory support from **IntentWave**: field experts who sanity-check his work. Advisors, not operators. *"just help me to know if i am not screwing anything up."*
  - **Google Ads — run by Coalition** (agency). Started **revamping Google Ads ~2 weeks ago** (~mid-Aug 2026). Has done HPC's **SEO for 2+ years**.
  - **Video — Garrett Frazier / Frazier Media**, engaged **~1 week ago** (~19 Aug 2026). **$500/video or $2,500 for 8.** Used ad hoc: ad videos, product content, shop content.
    - Video 1: company spotlight (broad brand overview) — **free promo** from Garrett
...
| **Banjo burners** — 6" $74 · 10" 200K BTU $139 | $74–$139 | The frying pathway Evan named. Cheap attach to any pot. |
| **4-Way Fryer / Pasta Cooker** $277.99–$299.99 · 4-Way 20 QT $379.99 | ~$278–$397 | Explicitly non-seasonal. |
| **40 QT Sauce Cooker** $289.99 / Sauce Stock Pot $258 | ~$258–$310 | Non-seasonal. |
| **Predator Gas Grills** $3,800–$4,350 (+ side burner $1,200–$1,750) | High ticket | Year-round category |
| **Navimow robotic lawn mowers** $799–$4,999 | High ticket | Adjacent/resale. Off brand-positioning entirely. |
| **Rugged Road coolers** ×5 | $249.99–$494.99 | Resale. Tailgate/lifestyle fit. |
| **Zydeco Fire** hot sauce / seasoning / combo | $5.95–$11.99 | **Consumables = repeat purchase.** Launched 2026-03-24. |
| **Merch** — tees $22, hats $20–$42, cups/bottles $24.99–$34.99 | Low | Brand/community |
...
`Commercial` 19 · `Steamer` 13 · `Dealer Marketing` 5 · `no-wholesale` 45 (so most SKUs *are* wholesale-eligible)

→ **Tailgating is already merchandised across 31 products but appears nowhere in the brand positioning.**
→ **Custom-logo / corporate-gift channel exists across 22 products and appears entirely unmarketed.**

#### Pricing corrections (brand brief was stale)
...
- **Beau's read:** Evan's year-round mandate is **not a product problem — the products already exist.**
  ...
  peak." Closing that gap is the $500K.
- **Flags:**
  - Are Navimow / Predator / Rugged Road **resale** lines with thinner margins? -> **Evan** (changes AOV + margin math)
  - What is the dealer/wholesale channel and what revenue does it carry? -> **Evan**
  - Is the RENTAL trailer promotable or a one-off? -> **Evan**
  - How are the two new bundles performing since 2026-07-13? -> **Evan**
  - Chrome extension not connected — blocks Meta/Google pulls -> **Evan** to install + sign in
...
| Line | Evan's ruling |
|---|---|
| **Steamer UNITS** | ⛔ **Not a priority.** Very niche — *"not many people, except for people in the Northeast, really do steaming."* Two variants: 28 QT (1 tray) and commercial (3 trays). A few 28 QTs sell. *"We don't push them as much because that burns marketing spend."* |
| **Steamer TRAYS** | ✅ **These DO sell — attached to pots.** Adjustable trays for **80 / 100 / 120 QT** pots; fixed basket-bottom trays for **every** pot size. Verified pricing: fixed $24.99–$59.99, adjustable shelf $119.99 (80/100 QT) and $159.99 (120 QT). |
| **Navimow mowers** | Sold, but *"a completely different product"* — not marketed. Leave alone. |
| **Predator Gas Grills** | ⛔ *"just a mock-up. Don't even pay attention to that."* Not real, not worth marketing. |
| **Rugged Road coolers** | Resale of a lightweight cooler brand. Sold occasionally. Not a focus. |
...
- **Flags:**
  - Unpublish the Predator mock-up? -> **Evan**
  - Are steamer trays currently cross-sold on pot PDPs / post-purchase email? -> **Evan / Biljana**
  - 40 QT fixed steamer insert shows out of stock -> **Evan**

### Q7 — Chrome extension: how it works and whether to grant access
- **Asked by Evan:** *"would you like me to set up the Cloud in the Chrome extension assuming that it will help you produce better work? Also, could you tell me how that works? As I don't want you changing anything if I were to give you access to that."*
- Answered in-session. Captured decision: **pending Evan.**
...
### Q9 — Product architecture (volunteered by Evan) + plan for the rest of the session
- **Captured — ⭐ the most important product fact of the session:**
  ...
  - **Why it matters commercially:**
    ...
    3. **Copy must never imply the burner is what makes it fast.** The pot is the technology.
  - **40 QT boiling pot discontinued** — *"it was in the middle of two sizes, and no one was really buying it."* The 40 QT **Sauce Cooker** and **Sauce Stock Pot** are a different line and remain live.
- **Evan's instruction on session structure:** work through everything that does **not** require browser access, then explicitly signal done so he can activate the Chrome extension.
- **Flags:** none new.

### Q10 — Customer truth: objections and buying reasons
- **Asked:** #1 objection, why buyers choose HPC, where reviews live.
- **Captured — highest-value copy material of the session. Written to `my-files (knowledge)/hpc-reference/customer-language.md`.**

**#1 objection = PRICE.** Shows up on sales calls **and in public comments on social posts.**
> Verbatim: *"That's way too expensive. Why would I ever buy that?"*

**Evan's answer:** propane + time savings. *"the tunnel tubes mounted on the bottom of the pot"* —
he restated unprompted that the burner is **not** the key focus. (New detail: tubes are on the
**bottom** of the pot.) Tubes + burner together = faster boil, faster **re-boil**, big gas savings.

**⭐ THE YETI FRAME — verbatim, Evan's own words:**
> *"It's like buying the really nice Yeti ice chest over a crappy Styrofoam ice chest that only lasts
> a little while. Our products, with good cleaning and care and maintenance, can last for generations.
...
verbatim. Do not improve it.** Guardrail: never claim a specific lifespan; keep it as "with good care,
these last generations" and let the 5-yr warranty carry the hard proof.

**Why customers buy (Evan's order):**
1. **Tunnel Tube technology specifically on the pots**
2. **Customer service**
...
- **Flags:**
  ...
  - No system for capturing sales-call language / DMs -> worth building
  - Are sales calls recorded? -> **Evan**

### Q11 — Freight economics
- **Captured (Evan's estimates, not exact):**
  - **Consumer products: the customer pays shipping on everything.** 120 QT averages **~$80**. Others vary by product.
  - **Commercial / LTL freight items:** 40 / 60 / 80 / 100 / 120 / 140 gallon cookers · all 40–140 gal Crawcuzzis · sorting tables · 100 QT steamer rack.
...
### Q13 — What's been tried that didn't work?
- **Captured — written up in full at `my-files (knowledge)/hpc-reference/what-weve-tried.md`.**

**⚠️ BM Digital (now Advantage HQ) — influencer agency. FAILED.**
Hired to source influencers, monitor their content output, and turn that content into Meta ads.
> Evan: *"in the end they screwed us out of a ton of money and did not have any sales to show for it.
> They were claiming that they generated more than 3/4 of our annual revenue when really they were
> just giving away our product for free to a ton of people who claimed they were going to make
> content but never did."*
...
- **Three rules extracted (now standing):**
  ...
  3. **Judge partners on incremental revenue, never on activity** (creators contacted, product shipped, posts promised).

**18 QT Giveaway (Sept 2025) — mixed, unmeasured.**
...
- **Beau's read:**
  ...
  - **$57.6K/yr to Coalition is the largest identifiable marketing line item known.** Given the BM Digital history, verifying its contribution against Shopify is a priority — hygiene, not distrust. **Unknown: whether $4,800 is management fee only or includes ad spend.** That materially changes the ROI math.
- **Flags:**
...
| # | Finding |
|---|---|
| 1 | 🚨 **Feb 2026: −$383,420 returns** — 90.2% of the month reversed, net sales **negative** in peak season. Normal months run $2.5K–$25K. **~13% of annual revenue.** Unexplained. |
| 2 | 🚨 **Dec 2025: 24.1% discount rate** — $169,721 off $703,194 gross. At 44.5% margin that lands near 20% gross, before ad spend. Biggest gross month of the year, possibly unprofitable. |
| 3 | 🟠 **Returns doubling:** 3.9% (Mar) → 8.2% (Aug). Suspected LTL freight damage. Worsening margin leak. |
| 4 | 🟢 **August up 4.4× YoY** ($19,763 → $87,938). **The year-round strategy is already working, unnamed and unresourced.** |
| 5 | ⭐ **18 QT Fish Fryer = #2 product for the year ($293,194) and #1 in August ($17,312, ~2× the 120 QT).** The off-season engine is proven, not hypothetical. |
| 6 | 🎯 **Break-even ROAS ≈ 2.4 blended.** Gross margin 44.5%. Core SKUs 43–49%. |
| 7 | **Scratch & Dent carries full margin (48.7%)** — a legitimate acquisition tool, not a margin sacrifice. |
| 8 | **Cooling Ring 54.1%, centering brackets 60.6%** — highest margins in the catalog. Strongest case yet for accessory attach on every pot PDP. |
...
- **Full report: `my-work (outputs)/internal/reports/2026-08-26-paid-media-baseline.md`.** Read-only; nothing changed.

**⭐ THE HEADLINE: both channels are profitable and both are being starved.**

| Channel | Window | Spend | Claimed value | ROAS | vs 2.4 break-even |
|---|---|---|---|---|---|
| Meta | Jul 12–Aug 24 | $10,614 | $74,778 | ~7.0 | 2.9× over |
| Google | Jul 20–Aug 20 | $17,436 | $93,551 | 5.37 | 2.2× over |

- **Google's UI says it explicitly:** *"You missed conversion value because you're limited by budget."* **3 of 5 campaigns flagged `Limited by budget`**, including both PMAX campaigns ($15,855 spend at 4.72–5.91 ROAS).
- **🚨 Meta spend cut 62%** — ~$20,200/mo (Jan–Jul 10) → ~$7,580/mo (Jul 12–Aug 24) — while ROAS held (7.75 → 7.05). Cutting the agency was right; cutting the budget alongside it appears to have happened by default, not by decision.
...
- **RECOMMENDATION — scale what already works** (all require Evan's click; Beau changed nothing):
  ...
  4. Raise `DSA | Search` off $35/day — 3.87 ROAS, budget-limited
  - **Guardrails:** ≤20–30% per campaign per week · halt if blended MER < 2.8 · expect efficiency decay · capacity is not a constraint (confirmed Q14)
- **Flags:**
  - What is `BPM` vs `BM |`? Which campaigns are agency-built? -> **Evan**
  - Coalition's $4,800/mo = **27.5% of Google spend**. High for management alone; also covers SEO. Actual split? -> **Evan**
  - Was the Meta budget cut deliberate or incidental? -> **Evan**
  - Google conv. value 46% modeled — how are conversions configured? -> **Evan / Coalition**
  - Second Google account (624-239-8327, "Setup in progress") — what is it? -> **Evan**
...
| Reviews | 25% |
| Fast Shipping | 25% |
| Features / Customer Service | 20% each |
| Friend's Recommendation | 15% |
| **Price** | **10%** |

- **⭐ THE INSIGHT OF THE SESSION: price is the #1 objection and almost never the reason anyone buys.** 80% choose on quality; 10% mention price. **Copy should stop defending price and lead with quality until price stops being the question.** Discounting recruits the 10% while eroding margin with the 80% — which reframes the Dec 2025 24.1% discount rate as likely buying customers who'd have bought anyway.
- Social proof + service (Reviews 25% + Customer Service 20% + Friend's Rec 15%) **outrank price 6:1.** Prominent review display and naming the humans who answer the phone beat any promo.

**📊 "Where did you hear about us first?" (n=20)**
| Source | % |
|---|---|
| **Google Search (organic)** | **50%** |
| **Facebook** | **30%** |
| Google Ads | 10% |
| **TikTok** | **5%** |
| Instagram | 5% |

- **Organic search is the single largest discovery channel and beats Google Ads 5:1.** Coalition's 2+ years of SEO are doing real work — and it strongly supports the how-to content plan.
- **⚡ TikTok registers at 5% with NO HPC account** — customers finding HPC via other people's TikTok content, at zero cost. Ties Instagram, where HPC actively posts. Strongest evidence yet to launch.

**😀 NPS = 75** (16 promoters / 3 passives / 1 detractor). Exceptional. **Customers aren't the problem — reach is.** The lone detractor cited only "Fast Shipping," worth watching against the rising return rate.

**🗣️ Verbatims captured** (written to `my-files (knowledge)/hpc-reference/customer-language.md`):
- *"I cooked some steak fingers, fries and okra in it and everything turned out perfect."* — 18 QT. **A customer describing the year-round use case unprompted, on HPC's #2 product.**
- *"...(No crawfish leakage). Love the lid hook to hang top on pot. HP Cookers rep met me after hours in mandeville at their shop for my pick up. THATS CUSTOMER SEEVICE."* — 120 QT
- *"Does everything advertised to do and more."* / *"It worked liked advertised."*
...
| SEO | **Coalition** | Same |
| Meta Ads | **Evan** (IntentWave advises) | Recommend concrete changes; Evan clicks |
...
- **Flags:**
  - Are the Google budget caps set by HPC or by Coalition? -> **Evan to ask**
  - Offer Coalition Shopify/margin visibility? -> **Evan**
...
It is **discounted at 21.8%** in August — ~5× the 18 QT (3.9%) and ~20× the 120 QT (1.1%). The 80 QT
and 100 QT took **zero** discount. 47.8% list minus 21.8% discount = the 28.9% realized margin.
...
|---|---|---|---|---|
| Dec 2025 | **$496,320** | −$148,896 (30%) | $0 | $347,424 |
| Feb 2026 | $0 | $0 | **−$347,424** | −$347,424 |

**One Lowe's dealer order, booked December, fully reversed in February.** It explains both anomalies.

| | As reported | **Corrected** |
|---|---|---|
| Dec 2025 net | $525,449 | **$178,025** (discount rate 24.1% → **10.1%**) |
| Feb 2026 net | −$7,392 | **+$340,032** (return rate 90.2% → **8.5%**) |

- ❌ **RETRACTED:** "December discounted 24.1% and may have been unprofitable." The consumer promo was fine.
- ❌ **RETRACTED:** "February was a catastrophic negative month." February was strong.
- ✅ **The corrected year is far more coherent:** soft December ($178K) → January warm-up → Feb $340K → Mar $558K → Apr $483K. A textbook crawfish curve.
- ⚠️ **Planning implication: December is SOFTER than November, not the year's second peak.** The Nov/Dec turkey-and-gifting window is a *smaller* opportunity than the raw numbers implied; **February is a bigger one.**

**C. Discount league table (12 mo) — consumer discounting is actually healthy**
...
full COGS against zero revenue (−$268.63). Connects directly to the **return rate doubling 3.9% → 8.2%**
since March. Aluminum on LTL. **Root-cause packaging/carrier review warranted.**

- **Report:** `my-work (outputs)/internal/reports/2026-08-26-discount-audit.md`. Corrections applied to `2026-08-26-shopify-baseline.md`, `my-files (knowledge)/hpc-reference/metrics-and-goals.md`, `my-business (context)/what-we-sell.md`.
- **Flags:**
...
- [x] Growth posture & targets — Q1
- [ ] Revenue shape — Venon data retracted. Product-line split still open.
- [x] Product catalog — Q5, self-served
- [~] Unit economics — freight ✅ Q11. **COGS is the last missing input.**
- [x] Paid media — Q16, pulled direct from both platforms
- [ ] Email/SMS reality (ESP, list size, flows)
- [ ] Site & CRO reality
- [x] Content production capability / time budget — Q12
- [x] Team, tools, vendors — Q4
- [~] Affiliate program — history understood; commission rate + platform still unknown
- [x] Customer truth — Q10 + Q17 (reviews.io: 80% buy on quality, 10% on price; NPS 75)
- [x] Ops constraints / capacity — Q14 (not a constraint)
